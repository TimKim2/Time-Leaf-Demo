...
public static class SerializedPropertyExtensions
{
	...
	public static void InsertToObjectArray<T> (this SerializedProperty arrayProperty, T elementToAdd, int number)
		where T : Object
	{
		if (!arrayProperty.isArray)
			throw new UnityException("SerializedProperty " + arrayProperty.name + " is not an array.");
		...
		//arrayProperty.InsertArrayElementAtIndex(arrayProperty.arraySize);
		arrayProperty.InsertArrayElementAtIndex(number);
		arrayProperty.GetArrayElementAtIndex(number).objectReferenceValue = elementToAdd;
